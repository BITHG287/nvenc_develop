...
int32_t Nv_Encoder::init(std::string out_file, int fps, int w, int h)
{
    ...
    _pCodecCtx->gop_size = 25;   // 每gop_size帧插入1个I帧，I帧越少，视频越小
    ...
    av_dict_set(&_pEncodeParam, "color_trc", "arib-std-b67", 0);
    av_dict_set(&_pEncodeParam, "colorspace", "bt2020nc", 0);
    av_dict_set(&_pEncodeParam, "f", "mpegts", 0);
    av_dict_set(&_pEncodeParam, "nal-hrd", "cbr", 0);
    av_dict_set(&_pEncodeParam, "b:v", "40000k", 0);
    av_dict_set(&_pEncodeParam, "muxrate", "40000k", 0);
